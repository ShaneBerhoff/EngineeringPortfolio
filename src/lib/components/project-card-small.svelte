...
<div
	class="m-4 flex h-[24rem] w-full max-w-7xl flex-grow flex-row justify-center space-x-2 overflow-hidden rounded-2xl border-2 border-gray-200 p-4 shadow-gray-200 transition-all hover:shadow-xl"
>
	<div class="flex h-full w-1/3 flex-col space-y-2">
		<div class="rounded bg-gray-200 p-4 text-center text-3xl font-bold">
			{project.title}
		</div>
		<div class="grid h-full min-h-0 grid-cols-1 grid-rows-2 gap-2">
	...
	<div class="grid h-full min-h-0 w-2/3 min-w-0 grid-cols-4 grid-rows-2 gap-2">
